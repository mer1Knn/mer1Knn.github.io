...
const options = {
  title: "Xoyox Communication and Events | Merouane",
  description:
...
export default async function Project() {
  const project = {
    ...
    Overview:
      "Crafting a customized web application designed to boost Xoyox's digital visibility, effectively showcase its diverse services, and ultimately attract a larger customer base.",
    Description:
      "The Xoyox Communication and Events project involved the creation of a web application to showcase the company's services in custom stands and event planning. The application included a portfolio of past projects, a showcase for all the previous client of the company, a complete presentation of the service and a way to contact the company for more details",
    MyRole: [
      "In this project, I served as the project manager and lead developer.",
      " My responsibilities included gathering requirements, designing the user interface, and overseeing the development team.",
      "I collaborated with Xoyox to ensure the application aligned with their brand identity and service offerings.",
    ...
    KeyTakeaways: [
      "This project allowed me to further hone my project management skills, working closely with the client to ensure their vision was accurately translated into a digital product.",
      " The application significantly enhanced Xoyox's online presence and increased their customer base.",
      "The success of this project reinforced the importance of effective collaboration and attention to detail in delivering successful solutions.",
    ],
    images: ["/Projects/xoyox-communication-and-events-website/1.png"],
    logo: "/Projects/xoyox-communication-and-events-website/logo.png",
  };
  return (
