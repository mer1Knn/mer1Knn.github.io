...
const options = {
  title: "Global Work Algeria | Merouane",
  description:
...
export default async function Project() {
  const project = {
    ...
    "Project Name": "Global Work Algeria Website",
    Company: "Global Work Algeria",
    url: "https://globalworkalgeria.com/",
    "Company description":
      "GLOBAL WORK ALGERIA is a company dedicated to creating high-quality professional CVs that enable the clients to stand out in an increasingly competitive international job market. Their mission is to help professionals present their experience, skills, and achievements convincingly and to tell their professional story in a captivating manner.",
    Overview:
      "Crafted a customized web application designed to boost Global Work Algeria digital visibility, effectively showcase its diverse services, and ultimately attract a larger customer base.",
    Description:
      "The Global Work Algeria project encompassed the creation of a tailored web application. This dynamic platform served as a powerful representation of the company's services while providing clients with a seamless and user-friendly interface. The application included a comprehensive presentation of the company and incorporated an admin panel for easy content management. As part of this project, I designed and implemented a CRM system within the application to empower the Global Work Algeria team to efficiently manage and track all registered clients on the website.",
    MyRole: [
      ...
      "I collaborated closely with the Global Work Algeria team to understand their unique requirements and implemented a tailored solution that met their needs.",
    ...
    images: ["/Projects/global-work-algeria-website/1.png"],
    logo: "/Projects/global-work-algeria-website/logo.png",
  };
  return (
